...
<div class="max-w-1xl mt-6 mx-auto dark">
	...
	<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800 min-h-[35vh]">
		<div class="md:flex md:justify-between">
			<div class="mb-6 md:mb-0" id="bottom">
				<a href="/" target="_blank" class="flex items-center">
                    ...
                    <span class="self-center ml-2 text-xl font-semibold whitespace-nowrap dark:text-white">{ title }</span>
				</a>
			</div>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
			<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© { thisYear } <a href="https://flowbite.com" target="_blank" class="hover:underline">{ title }</a>. All Rights Reserved.
</span>
			<div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
				<a href="https://facebook.com/raz0229" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
				...
				<a href="https://instagram.com/raz0229" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fill-rule="evenodd"
				...
				<a href="https://twitter.com/raz0229" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path
				...
				<a href="https://github.com/raz0229" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fill-rule="evenodd"
				...
				<a href="https://raz0229.github.io" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fill-rule="evenodd"
